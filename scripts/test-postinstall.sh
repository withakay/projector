...
echo "======================================"
echo "Testing Spool Postinstall Script"
echo "======================================"
echo ""

# Save original environment
ORIGINAL_CI="${CI:-}"
ORIGINAL_SPOOL_NO_COMPLETIONS="${SPOOL_NO_COMPLETIONS:-}"

# Test 1: Normal install
echo "Test 1: Normal install (should attempt to install completions)"
echo "--------------------------------------"
unset CI
unset SPOOL_NO_COMPLETIONS
...
echo "Test 3: SPOOL_NO_COMPLETIONS=1 (should skip silently)"
echo "--------------------------------------"
unset CI
export SPOOL_NO_COMPLETIONS=1
node scripts/postinstall.js
...
if [ -n "$ORIGINAL_SPOOL_NO_COMPLETIONS" ]; then
  export SPOOL_NO_COMPLETIONS="$ORIGINAL_SPOOL_NO_COMPLETIONS"
else
  unset SPOOL_NO_COMPLETIONS
fi
